 ...
 */
public class FragmentText extends Fragment implements FuzzResponse {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.text_fragment_rv, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        rv = (RecyclerView)getActivity().findViewById(R.id.recyclerview_text);
    ...
    public void processFinish(List<FuzzPOJO> fuzzPOJO) {
       ...
       /* for(int i = 0; i < fuzzPOJO.size(); i ++){
        ...
        RVAdapterText rvAdapter = new RVAdapterText(fuzzPOJO, mContext);
